...
origin = testbench("exercise2_2/testbench_driver.c", "exercise2_2/matrix_multiply.c", "exercise2_2/a.out", "exercise2_2/ans.output")
origin.compile()
origin.run()
origin.print()
print("-----------------------------------")
...
improve = testbench("exercise2_2/testbench_driver.c", "exercise2_2/matrix_multiply_improved.c", "exercise2_2/a.out", "exercise2_2/stu.output")
improve.compile()
improve.run()
improve.print()
print("-----------------------------------")
...
correct_result = open("exercise2_2/ans.output", 'r')
student_result = open("exercise2_2/stu.output", 'r')
